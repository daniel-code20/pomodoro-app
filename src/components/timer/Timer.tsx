...
const Timer = () => {
  const { secondsLeft, isRunning, mode, rounds, start, pause, reset, setMode } =
    useTimer();
  ...
  return (
    <>
      <div className="w-full flex flex-col items-center gap-8">
        ...
        {/* Time */}
        <span className="text-7xl sm:text-8xl md:text-9xl font-bold text-neutral-800 dark:text-white tracking-tight whitespace-nowrap">
